...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20231007_entreprisedeconstruction_288ead8aa28e2f949081_20231007105813_archive.zip';
        const ARCHIVE_SIZE       = '87757674';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '288ead8-07105813';
        const SECONDARY_PACKAGE_HASH = '0a029fb-07105813';
        const VERSION            = '1.5.6';
